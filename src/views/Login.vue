        ...
        <div class="flex-1">
          ...
          <div class="mt-8">
            <form @submit.prevent="login">
              ...
              <div>
                <button type="submit" class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-green-900 rounded-lg hover:bg-green-700 focus:outline-none focus:bg-green-600 focus:ring focus:ring-green-300 focus:ring-opacity-50">
                  Iniciar sesión
                </button>
              </div>
            </form>
